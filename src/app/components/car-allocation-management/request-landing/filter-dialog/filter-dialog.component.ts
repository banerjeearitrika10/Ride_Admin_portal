...
export class AllocationFilterDialogComponent implements OnInit, OnDestroy  {
  ...
  constructor(
    public dialogRef: MatDialogRef<AllocationFilterDialogComponent>,
  ...
  refreshTable() {
    this.filterForm.reset()
    this.bookingService.emitAllocationSearchDataForFilter({})
